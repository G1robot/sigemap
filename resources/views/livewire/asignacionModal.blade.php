<div class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 backdrop-blur-sm z-40 animate-fade-in-down p-4">
    <div class="max-w-5xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-full">
        ...
        <div class="p-6 overflow-y-auto">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <!-- SELECT DE RUTA Y TARJETA DINÁMICA -->
                    <div class="bg-gray-50 p-3 rounded-xl border border-gray-100">
                        <label class="block text-xs font-bold text-gray-600 uppercase mb-1">Ruta a Cubrir *</label>
                        <select wire:model.live="id_ruta" class="w-full border border-gray-300 rounded-lg p-2.5 text-sm bg-white shadow-sm focus:ring-2 focus:ring-orange-500">
        ...
        <div class="bg-gray-50 px-6 py-4 flex justify-end gap-3 border-t border-gray-100">
            ...
            <button wire:click="guardarPlanificacion" wire:loading.attr="disabled" wire:target="guardarPlanificacion" class="px-5 py-2.5 text-sm font-bold text-white bg-orange-500 hover:bg-orange-600 rounded-lg flex items-center gap-2 transition-all">
