    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
        ...
        <div class="relative w-full md:w-80">
            ...
            <input type="text" wire:model.live.debounce.300ms="search" 
                ...
                class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 bg-gray-50 text-sm">
        </div>
    </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <div class="flex justify-end gap-1">
                                    <button wire:click="abrirAsistencia({{ $item->id_asignacion }})" 
                                        class="text-gray-500 hover:text-green-600 transition p-2 rounded-lg hover:bg-green-100" title="Ver Cuadrilla / Tomar Asistencia">
